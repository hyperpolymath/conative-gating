...
**Gap**: Need Ada, Elixir, Zig, Haskell, AffineScript templates
...
[source,yaml]
----
# templates/affinescript.yml
# GitLab CI for AffineScript projects
...
2. Contribute RSR language templates (Ada, Elixir, AffineScript, Zig)
