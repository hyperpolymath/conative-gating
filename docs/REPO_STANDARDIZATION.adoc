...
* Encoding: UTF-8
* Indent: 2 spaces (YAML, JSON, Guix), 4 spaces (Rust, Python)
...
- Language tags: `rust`, `affinescript`, `elixir`, `zig`, `ada`, `haskell`
...
package.json:: Node/AffineScript projects
* Dependencies
* Scripts
...
|AffineScript |~12 |affinescript.json, src/*.res
