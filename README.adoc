...
LLMs are trained to be helpful, which makes them systematically violate explicit project constraints. When given rules like "NEVER use TypeScript, use AffineScript", LLMs:
...
* Rust, Elixir, Zig, Ada, Haskell, AffineScript
...
* link:docs/NICKEL-POLICY.adoc[Native Nickel Policy Backend]
* link:docs/SLM_PROVIDERS.adoc[SLM Provider Backends]
* link:docs/ARBITER_PROTOCOL.adoc[Consensus Arbiter Protocol]
