...
git clone <https://github.com/hyperpolymath/conative-gating.git> cd
conative-gating
...
toolbox create conative-gating-dev toolbox enter conative-gating-dev \#
...
conative-gating/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
