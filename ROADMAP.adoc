...
| SLM Evaluator
| [green]#*BACKENDS LANDED*#
| Real `llama-cli` + HTTP providers, contract-verified; model calibration open

| Consensus Arbiter
| [green]#*BACKENDS LANDED*#
| Protocol v1 escript + durable audit sink + Rust client; ops hardening open

| Native Nickel policies
| [green]#*FEATURE LANDED*#
| Vendored Bunsenite backend; CI-verified build (memory-gated)
